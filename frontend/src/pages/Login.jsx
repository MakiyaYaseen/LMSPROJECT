...
const Login = () => {
  ...
  return (
    <div className="bg-[#dddbdb] w-screen h-screen flex items-center justify-center ">
            <form 
        className="w-[90%] md:w-[800px] h-[620px] bg-white shadow-xl rounded-2xl flex relative"
        onSubmit={(e)=>e.preventDefault()} >
          <FaArrowLeftLong 
                      className='absolute top-[16%] md:top-[16%] left-[5%] w-[22px] h-[22px] cursor-pointer text-gray-700 hover:text-black transition-colors' 
                      onClick={() => navigate('/')} 
                  />
        {/* Left side */}
        <div className='md:w-[50%] w-full h-full flex flex-col items-center justify-center gap-4'> 
          ...
          <div className='flex flex-col gap-1 w-[80%] items-start justify-center relative'>
            ...
            { !show ? 
              <IoEyeOutline 
                className='absolute w-[20px] h-[20px] cursor-pointer left-[90%] bottom-[10%]' 
          ...
          <span className='text-[15px] cursor-pointer text-[#585757]'onClick={()=>navigate("/forget")}  >
          ...
          <div className="w-[80%] flex items-center justify-center gap-4 mt-2">
            ...
            <p className="text-[#6f6f6f] text-[15px]">Or Continue</p>
            <div className="h-[1px] w-[25%] bg-[#d9d9d9]"></div>
          </div>

          {/* Google */}
          <div className='w-[80%] h-[40px] border border-black rounded-[5px] flex items-center justify-center'onClick={googleLogin}>
        ...
        {/* Right Side Logo */}
        <div className='w-[50%] h-full rounded-r-2xl bg-black flex items-center justify-center flex-col hidden md:flex'>
