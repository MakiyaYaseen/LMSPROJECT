  ...
  return (
    <div className='min-h-screen bg-gray-50 p-6 flex flex-col md:flex-row gap-6'>
      ...
      <div className='w-full md:w-2/3 bg-white rounded-2xl shadow-md p-6 border border-gray-200'>
          <div className='mb-6'>
            <h2 className='text-2xl font-bold flex items-center justify-start gap-5 text-gray-800'><FaArrowLeftLong className='text-black w-[22px] cursor-pointer' onClick={()=>navigate("/")} />{selectedCourse?.title}</h2>
        ...
        {/* video player   */}
        <div className='aspect-video bg-black rounded-xl overflow-hidden mb-4 border-gray-300' >
